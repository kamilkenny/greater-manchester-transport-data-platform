...
from transport_platform.database.sql_server import (
    build_bulk_connection_string,
...
def test_build_bulk_connection_string_omits_odbc_driver() -> None:
    settings = Settings(
        tfgm_gtfs_url="https://example.test/gtfs.zip",
        sql_server_host="127.0.0.1",
        sql_server_port=14330,
    ...
    connection_string = build_bulk_connection_string(settings)
